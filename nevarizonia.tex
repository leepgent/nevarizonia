...
\usepackage[pdfauthor={Lee Gent},pdftitle={Nevarizonia: An American Road Trip},pdfsubject={Nevarizonia}]{hyperref}
...
\vfill
\hrule
\begin{center} {\scriptsize Copyright \textcopyright 2005 -- 2010 Lee Gent \\ lee@leegent.net }  \end{center}
